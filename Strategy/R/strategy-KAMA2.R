...
strategy.kama2 <- function(prices, weights=NULL, indicators=NULL, parameters=list(), printSteps=F) {
  ...
  # OUTPUT
  return( list(strat.vals=list(KAMA2.vals=strat.vals), signals=signals, prices=prices, logReturns=logReturns, weights=weights, indicators=indicators, parameters=parameters) )
}
